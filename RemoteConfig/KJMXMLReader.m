...
@interface KJMXMLReader (Internal)
...
+ (NSMutableDictionary *)dictionaryForPath:(NSString *)path error:(NSError *__autoreleasing *)errorPointer
{
    ...
    NSMutableDictionary *rootDictionary = [KJMXMLReader dictionaryForXMLData:data error:errorPointer];
...
{
    KJMXMLReader *reader = [[KJMXMLReader alloc] initWithError:error];
